# Outreach and adoption log (manual)
...
When a pilot runs, add a row:

```text
YYYY-MM-DD | Pilot: <institution/course> | <N> students | Instructor self-report | Labs 1–4, hardware-free track
```

## Privacy

Do not record student names, grades, or institutional contracts in this public repository.
