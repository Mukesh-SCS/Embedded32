...
/**
 * Write to console with constant format strings and sanitized arguments.
 * Each user-controlled field is passed through sanitizeLogText as a separate argument.
 */
